package me.meyProjects.microservice.core.aspect;
...
import uyun.octopus.openApi.core.bean.Parameters;
import uyun.octopus.openApi.core.constant.HttpStatusCode;
import uyun.octopus.openApi.core.constant.MethodParameters;
import uyun.octopus.openApi.core.exception.*;
...
public class ParamsValidatorHandler {
    ...
    /* 参数验证   */
        ...
        try {
            ...
            throw new OctopusOpenApiException();
        }
    }
}
