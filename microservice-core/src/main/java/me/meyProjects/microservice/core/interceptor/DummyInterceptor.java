...
import me.meyProjects.microservice.core.constant.RequestParam;
import me.meyProjects.microservice.core.exception.MicroServiceException;
import me.meyProjects.microservice.core.exception.UnauthorizedRequestException;
...
import static me.meyProjects.microservice.core.utils.ParamsHolder.setParameter;
...
public class DummyInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
        ...
        String apiKey = getParamString(RequestParam.API_KEY.getName());
        boolean failed;
        try {
            failed = !auth(apiKey);
        } catch (Exception e) {
    ...
    private void getCookieParams(HttpServletRequest request) {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                setParameter(cookie.getName(), cookie.getValue());
            }
        }
    }
